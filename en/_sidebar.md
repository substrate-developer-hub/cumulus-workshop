...
- [Launch with `polkadot-launch`](en/4-automation/1-polkadot-launch)
- [Parachain Development](en/5-develop/1-template-overview)
  - [Template Pallet](en/5-develop/2-template-pallet)
  - [External Pallet](en/5-develop/3-external-pallet)
- [Rococo Testnet Registration](en/6-rococo-registration/1-register)
